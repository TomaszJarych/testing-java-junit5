...
class OwnerMapServiceTest {
        ...
        class SaveOwnersTests {
            ...
            class FindOwnersTests {
                ...
                void findOwnerNotFound() {
                	//differet lifecycle of test, 
                	// only applies BeforeEach from TestCreatePetTypes and SaveOwnersTests and 
                	//not owner added in saveOnwer Test
    ...
    void ownersAreStillZero() {
        int ownerCount = ownerMapService.findAll().size();
        // only applies BeforeEach from TestCreatePetTypes, so there is no owner added at all!
        assertThat(ownerCount).isZero();
    }
}